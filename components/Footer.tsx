    ...
    <footer className='w-full pt-20 pb-10' id="contact">
        ...
        <div className='flex flex-col items-center'>
            <h1 className='heading lg:max-w-[45vw]'>
                Ready to take <span
                className='text-purple'>your</span> digital presence to the next level?
            </h1>
            <p className='text-white-200 md:mt-10 my-5 text-center'>
                Reach out to me today I can help you to achive your goals.
            </p>
            <a href='mailto:375savinuransinghe@gmial.com'>
            <MagicButton
        ...
        items-center'>
            ...
            font-light'>Copyright© 2024 Savinu</p>
